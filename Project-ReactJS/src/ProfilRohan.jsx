...
const ProfilRohan = () => {
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white p-6 md:p-12 font-sans tracking-tight relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 lg:gap-24 relative z-10">
        ...
        <div className="w-full md:w-[45%] flex flex-col items-center md:items-start md:sticky md:top-12">
        ...
        <div className="w-full md:w-[55%] space-y-16 py-4">
          <section className="space-y-8">
            <div className="flex items-center gap-6">
              <h1 className="text-sm font-black tracking-[0.5em] text-white uppercase italic">About Me</h1>
              <div className="h-[1px] flex-grow bg-gradient-to-r from-white/20 to-transparent"></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-4">
                <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Biodata</span> <br /><br />
              ...
              <div className="space-y-4">
                <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Goals</span> <br /> <br />
                <p className="text-sm leading-relaxed text-slate-400 text-justify font-medium">
          ...
          <section className="relative p-10 rounded-[2.5rem] overflow-hidden group border border-white/5 bg-white/[0.02]">
          ...
          <footer className="flex justify-between items-end pt-12 border-t border-white/5 opacity-30">
