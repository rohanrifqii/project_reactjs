...
import ProfilAmar from "./page/ProfilAmar";
  ...
  return (
    <BrowserRouter>
      <Routes>
        <Route
          ...
          element={
            <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50">
              <h1 className="text-4xl font-extrabold text-slate-800 mb-4">Project Based Task - ReactJS</h1>
              <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/amar" className="bg-sky-600 hover:bg-sky-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all hover:scale-105 text-center">
                  Profil Rama
                </Link>
              </div>
            </div>
        ...
        <Route path="/amar" element={<ProfilAmar />} />
      </Routes>
    </BrowserRouter>
  );
}
